@testset "Dscribe ACSF Descriptor" begin

@info("Testing Dscribe ACSF Descriptor for dc Si with cutoff=6.5 and Behler2011 parameters.")
using DScribe, JuLIP, Test

at = bulk(:Si, cubic=true)
desc = dscribe_acsf(at)
...
acsf_now = vcat(desc[1,2:end]...)
println("DScribe.jl ACSF returns:",acsf_now)
